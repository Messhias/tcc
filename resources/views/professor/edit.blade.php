...
<section class="content">
    ...
    <ol class="breadcrumb breadcrumb-col-pink">
        ...
        <li><a href=' {{ route( 'professors' ) }} '><i class="material-icons">school</i> Docentes</li></a>
        <li class="active"><i class="material-icons"> playlist_add</i> Editar {{ $professor->name . ' ' . $professor->middlename . ' ' . $professor->lastname }}</li>
    </ol>


    <div class="container-fluid">
        <div class="block-header">
            <h2>Professor(a) {{$professor->name . ' ' . $professor->middlename . ' ' . $professor->lastname }}</h2>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Editar PROFESSOR(a): {{ $professor->name }}
                        </h2>
                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    {{
                                                        Form::date('birthdate',
                                                        date( 'd/m/Y', strtotime ( $professor->birthdate ) ),
                                                        [
